...
class MLA(nn.Module):
    def __init__(self, config: Config):
        ...
        # Down-projection matrices - 完全保持原始实现
        ...
        # Up-projection matrices - 完全保持原始实现
    ...
    def forward(self, x: torch.Tensor, kv_cache: KVCache) -> torch.Tensor:
        ...
        # Handle queries Q first - 完全保持原始实现
        ...
        # Handle keys and values K/V - 完全保持原始实现
        ...
        # Compute RoPE for queries - 完全保持原始实现
        ...
        # Compute RoPE for keys - 完全保持原始实现 
        k_rope = k_rope[:, :, None, :]
